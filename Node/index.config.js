...
var index_config_default = {
 ...
 t4: {list: [
    ...
    {name: "🍏金鹰",
      address: "https://jyzyapi.com/provide/vod/"},
    {name: "🍏樱花",
    ...
    {name: "🍏虎牙",
      address: "https://www.huyaapi.com/api.php/provide/vod/from/hym3u8/at/json"},
    {name: "🍏如意",
      address: "https://cj.rycjapi.com/api.php/provide/vod"},
    {name: "🍏速播",
      address: "https://subocaiji.com/api.php/provide/vod/"},
    {name: "🍏极速",
      address: "https://jszyapi.com/api.php/provide/vod/at/json"},
    {name: "🍏暴风",
      address: "https://bfzyapi.com/api.php/provide/vod/"},
    {name: "🍏非凡",
      address: "https://cj.ffzyapi.com/api.php/provide/vod/"},
    {name: "🍏火狐",
      address: "https://hhzyapi.com/api.php/provide/vod/at/json"},
    {name: "🍏茅台",
      address: "https://caiji.maotaizy.cc/api.php/provide/vod/from/mtm3u8/at/josn"},
    {name: "🍏天堂",
      address: "http://caiji.dyttzyapi.com/api.php/provide/vod/from/dyttm3u8/at/json"},
    {name: "🍏西瓜",
      address: "https://caiji.xgzyapi.com/api.php/provide/vod/"},
    {name: "🍏豪华",
      address: "https://hhzyapi.com/api.php/provide/vod/at/json"},
    {name: "🍏无印",
    ...
    {name: "🍏旺旺",
      address: "https://tyyszyapi.com/api.php/provide/vod/"},
    {name: "🍏鸭鸭",
  ...
  {name: "🍊湿园", address: "https://xxavs.com/api.php/provide/vod/at/json"},
  {name: "🍊白嫖", address: "https://www.kxgav.com/api/json.php"},
  {name: "🍊黄油", address: "https://www.pgxdy.com/api/json.php"},
  {name: "🍊美少女", address: "https://www.msnii.com/api/json.php"},
  {name: "🍊淫水机", address: "https://www.xrbsp.com/api/json.php"},
  {name: "🍊香奶儿", address: "https://www.gdlsp.com/api/json.php"},
